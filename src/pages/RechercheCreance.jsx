...
//             <InputLabel id="zone-label" shrink>Type de zone</InputLabel>
//             <Select
//               labelId="zone-label"
//               id="zone-select"
//               value={zone || "none"}
...
//                 PaperProps: { style: { maxHeight: 300, zIndex: 2000 } },
//               }}
//             >
//               <MenuItem value="none"><em>Aucun</em></MenuItem>
//               {zonesPossibles.map((z) => (
...
//         <Grid item xs={12} sm={6} md={4}>
//           <FormControl fullWidth size="small" variant="outlined">
//             <InputLabel id="etat-label" shrink>État de la créance</InputLabel>
//             <Select
//               labelId="etat-label"
//               id="etat-select"
//               value={etat || "none"}
