...
import { useUserManagement } from '../hooks/useUserManagement'; // ⬅️ IMPORT DU HOOK
import { UserFormDialog } from '../components/UserFormDialog'; // ⬅️ IMPORT DU DIALOGUE
      ...
      >
        <Toolbar sx={{ 
          ...
          <Button
            variant="contained"
            startIcon={<AddIcon />}
            onClick={handleOpenAddDialog} // Appel au handler du hook
            sx={{ 
              borderRadius: 2,
              px: 3,
              py: 1,
