...
export default function Dashboard() {
  ...
  return (
    <>
      {showNavbarSidebar && <Navbar handleDrawerToggle={handleDrawerToggle} />}
      {showNavbarSidebar && <Sidebar mobileOpen={mobileOpen} handleDrawerToggle={handleDrawerToggle} />}
      
      {/* Contenu principal */}
      <main
        className={`pt-16 p-4 ${showNavbarSidebar && !isMobile ? 'ml-60' : ''}`}
